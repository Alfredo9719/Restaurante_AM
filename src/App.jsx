            ...
            <h3 className='mb-3'>Reservación</h3>
              <form onSubmit={reservar}>
                ...
                <div className="mb-3">
                  ...
                  <input type='date' className="form-control" rows="5" name='reservacion' onChange={handleInputChange}></input>
                </div>
                <div className="mb-3">
                  <label className="form-label">Hora</label>
                  <input type='time' className="form-control" rows="5" name='reservacion' onChange={handleInputChange}></input>
                </div>
                <div className="mb-3">
